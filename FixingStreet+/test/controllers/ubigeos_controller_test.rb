...
class UbigeosControllerTest < ActionController::TestCase
  ...
  test "should create ubigeo" do
    assert_difference('Ubigeo.count') do
      post :create, ubigeo: { code: @ubigeo.code, level: @ubigeo.level, name: @ubigeo.name, status: @ubigeo.status }
    end
  ...
  test "should update ubigeo" do
    patch :update, id: @ubigeo, ubigeo: { code: @ubigeo.code, level: @ubigeo.level, name: @ubigeo.name, status: @ubigeo.status }
    assert_redirected_to ubigeo_path(assigns(:ubigeo))
  end
